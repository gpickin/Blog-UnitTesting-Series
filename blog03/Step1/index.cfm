<html>
	...
	<body>
		...
		Blog 03 Index - Unit Testing 03 - More TDD - Building out our Component Objects</h3>
		...
		<cfset r = new testbox.system.testing.TestBox( directory="blog03.Step1.test.unit") >
